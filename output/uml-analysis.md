...
1. **Analyze the source code above** and extract ONLY the essential information for a simple UML class diagram
...
### For UML Class Diagram - Extract Essentials:

**Extract:**
- Class names and key attributes (name: type)
- Main methods (name, params, return type)
- Primary relationships: inheritance, composition, key associations

**Output:**
Concise prompt listing: classes with core attributes/methods, relationship type between classes. Use abbreviated format to minimize tokens.
---

## Summary

**Your Task:** Extract ONLY essential UML-specific information that actually exists in the source code above. Generate a simple, token-efficient prompt for another LLM to create a basic UML class diagram. 
