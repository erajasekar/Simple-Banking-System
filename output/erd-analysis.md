...
1. **Analyze the source code above** and extract ONLY the essential information for a simple ERD diagram
...
### For Entity Relationship Diagram - Extract Essentials:

**Extract:**
- Entity names with key attributes (name: type, mark PK/FK)
- Relationships with cardinality (1:1, 1:N, M:N)

**Output:**
Concise prompt: entities list with attributes, then relationships as "Entity1 --[1:N]--> Entity2".
---

## Summary

**Your Task:** Extract ONLY essential ERD-specific information that actually exists in the source code above. Generate a simple, token-efficient prompt for another LLM to create a basic ERD diagram. 
